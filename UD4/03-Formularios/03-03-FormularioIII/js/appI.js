...
const validarInputs=function(){
    ...
    for (let elemento of inputText){
        //Accedemos al span de error asociado al elemento para escribir en él si hubiera un error o limpiarlo si hubiera un error previo y hubiera que limpiarlo
