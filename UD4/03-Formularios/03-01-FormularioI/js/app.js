...
const ejecutar=(e)=> {
  ...
  //*** 1ª mediante el nombre del formulario y el nombre de la caja de texto utilizando el operador .
  ...
  document.formNameBusq.nombre.value="Juan";
  ...
  //También podemos acceder a los elementos de la colección elements mediante su nombre.
