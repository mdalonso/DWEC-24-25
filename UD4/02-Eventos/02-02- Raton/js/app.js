...
const establecerEvent=()=>{
    ...
    for (const element of elementosInput) {
        ...
        //Podemos combinar varios eventos estableciendo condicionoes en unos sobre otros
        // Por ejemplo, si se mueve el ratón mientas se mantiene el click, que el fondo del
