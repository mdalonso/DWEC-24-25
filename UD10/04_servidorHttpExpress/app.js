...
//Importamos la librería para poder utilizarla (hay que modificar package.json)
import express from 'express';

//la constante app va a recibir una instancia del objeto express (servidor), con toda la funcionalidad del framework
...
app.get("/", (req, res)=>{
    ...
    //En este caso estamos enviando como respuesta una cadena
