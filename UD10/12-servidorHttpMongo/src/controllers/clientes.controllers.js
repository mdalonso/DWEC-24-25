...
//Necesitamos el tipo de objeto ObjectId perteneciente a mongo el cual es el utilizado
//para crear el identificador automático de cada documento (registro)
...
export const getCliente=async(req, res)=>{
    try {
        ...
        //QUERY
        //aunque aparece como deprecated, es un deprecated a futuro y no hay aún alternativa para
