...
//cuando se desea exportar más de un elemento éstos se pasan formando un objeto JS de manera que para cada uno 
//se puede indicar un nombre distinto del de su definición si se desea.
//cada elemento de ese objeto será un par nombre:elemento donde:
