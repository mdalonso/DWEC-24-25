...
//Como http no es un módulo ESM, para utilizar el import debemos modificar el archivo package.json ("type"="module")
...
server.listen(PORT,()=>{
    console.log('Aquí estoy escuchando tu solicitud');
});