...
router.get("/login", async(req, res)=>{
        ...
        //El resultado que se obtiene de la query es una colección de 2 objetos (podemos quitar
        //los corchetes a result para comprobarlo)
        //El primer objeto contiene los datos devueltos por la query
        //El segundo objeto contiene metadatos sobre las columnas devueltas
