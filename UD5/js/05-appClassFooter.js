 ...
 *      en relación a la altura del contenedor, en este caso del footer) Por este motivo el footer aparece oculto cuando se carga la página.
...
window.addEventListener("DOMContentLoaded",()=>{
    //Formas de acceder a las clases asignadas a un elemento
    const formulario=document.querySelector("#formulario");
    console.log(formulario.classList);
    console.log(formulario.className);

    
    //Localizamos el footer utilizando el selector .footer
    //También se podría haber utilizado el selector #footer
    ...
    //    console.log("pulsar botón");
        ...
        //La clase activo modifica las propiedades css del footer para que se muestre.
