...
const confFormulario = () => {
  ...
  //Una regla personalizadda se define mediante el método addMethod el cual recibe como parámetro:
  //-el nombre de la regla (regex)
  //-una función que define la lógica de validación. Esa función recibe tres parámetros:
  //        - El valor que hay que validar.
  //        - El elemento que se está validando
  //        - el valor que se establece en la regla de validación en la definición de rules.
  $.validator.addMethod("regex", function (value, element, regexp) {
    //Se crea un objeto RegExp con la expresión regular
  ...
  $("#frmFirst").validate({
    ...
    rules: {
      ...
      nombre: {
        ...
        //Regex es un método de validación personalizado que recibe como parámetro de entrada la expresión regular
