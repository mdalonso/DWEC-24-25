...
const mostrarTabla=()=>{
    ...
    $(".table").DataTable({
        ...
        // - single: Selección simple de items.
        // - multi: Permite seleccionar varios items pero no rangos con shift
        // - multi+shift: Permite seleccionar un rango de items adyacentes además de multi
        // - os: Permite realizar selecciones tal y como se permite en la plataforma que se
        //          está ejecutando, es decir, multi pulsando ctrl
        ...
        //      ahí la selección.
        //Para probar esto tenemos que descomentar las líneas 35 y 44 del documento html
        /*    "select":{
             style:'os',
