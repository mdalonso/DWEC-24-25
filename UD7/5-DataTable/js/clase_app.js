"use strict"
//index.html --> se usa con app.js

//Este ejemplo es una muestra de cómo dar formato a una tabla utilizando la librería DATATABLES en el caso de que 
//la tabla html ya esté construída y con datos cargados antes de crear el objeto datatables.
...
const mostrarTabla=async()=>{
    ...
    try {
        ...
        //- En primer lugar, procesamos el objeto response (primer then)
        //- En segundo lugar, procesamos los datos envueltos en ese objeto response (segundo then).
       ...
       //a las filas seleccionadas les asignaremos una clase cuando se haga click.
       ...
       $('.table tbody tr').on('click', function(){
        ...
        $(this).toggleClass("selected");//La clase selected es de DataTables
        })
